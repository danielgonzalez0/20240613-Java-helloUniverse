...
public class Voiture extends VehiculeAMoteur implements Vidangeable {
  ...
  public void vidanger() {
    System.out.println(
        "Dévissez le bouchon sous la culasse et attendez que l'huile s'écoule. Remettez le bouchon et versez de l'huile neuve.");
  }
  ...
  public void immatriculer(String immatriculation)
      throws VoitureDejaImmatriculeeException, NombreCaracteresInvalidesException {
    if (immatriculation.length() != 9) {
      throw new NombreCaracteresInvalidesException("Le nombre de caractères de l'immatriculation est invalide");
    }
    if (this.immatriculation != null) {
      throw new VoitureDejaImmatriculeeException("La voiture a déjà une immatriculation");
    }
